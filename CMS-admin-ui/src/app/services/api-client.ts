...
export class Client {
  ...
  ): Observable<PostInListDtoPageResult> {
        ...
        _observableCatch((response_: any) => {
          if (response_ instanceof HttpResponseBase) {
            try {
              ...
              return _observableThrow(
                e
              ) as any as Observable<PostInListDtoPageResult>;
            }
          } else
            return _observableThrow(
              response_
   ...
   * @return Success
   */
  deletePosts(ids: string[] | null): Observable<void> {
    let url_ = this.baseUrl + '/api/admin/post/{ids}';
